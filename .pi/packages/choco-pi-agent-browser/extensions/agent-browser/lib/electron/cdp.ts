...
export type ElectronCdpJson =
  | string
  | number
  | boolean
  | null
  | ElectronCdpJson[]
  | { [key: string]: ElectronCdpJson };
...
export function parseCdpVersion(
  value: ElectronCdpJson | undefined,
): ElectronCdpVersion | undefined {
...
export async function fetchCdpJson(
  url: string,
  signal?: AbortSignal,
): Promise<ElectronCdpJson | undefined> {
