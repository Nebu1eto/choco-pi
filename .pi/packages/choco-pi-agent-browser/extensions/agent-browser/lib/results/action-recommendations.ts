import { isOpenNavigationCommand, isPageMutationCommand } from "../command-taxonomy.ts";
import { isPendingRecordingArtifact } from "./artifact-manifest.ts";
import type {
...
import { applySessionToNextActions, buildNextToolAction, type AgentBrowserNextAction } from "./next-actions.ts";
import {
