import type { SnapshotRefEntry } from "./snapshot-refs.ts";
...
interface SnapshotHighValueControlRolePriorities {
  [role: string]: number;
}

const SNAPSHOT_HIGH_VALUE_CONTROL_ROLE_PRIORITY: SnapshotHighValueControlRolePriorities = {
  searchbox: 0,
  textbox: 1,
  combobox: 2,
  button: 3,
