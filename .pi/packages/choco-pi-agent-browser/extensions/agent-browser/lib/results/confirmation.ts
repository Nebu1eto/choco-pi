...
function getTrimmedStringField<Value>(data: Record<string, Value>, fieldNames: readonly string[]): string | undefined {
...
function getNestedConfirmationRecord<Value>(data: Record<string, Value>): RuntimeRecord<unknown> | undefined {
...
export function detectConfirmationRequired<Value>(data: Value): ConfirmationRequiredPresentation | undefined {
	if (!isRecord(data)) {
		return undefined;
	}
