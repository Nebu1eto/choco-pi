...
import { extractUpstreamCommandTokens, type CommandInfo } from "../runtime.ts";
...
import { buildSnapshotPresentation } from "./snapshot.ts";
import { parseJsonPreviewString, redactModelFacingText, stringifyModelFacing } from "./presentation/common.ts";
import {
...
} from "./presentation/artifacts.ts";
import { buildBatchPresentation, isAgentBrowserBatchResultArray } from "./presentation/batch.ts";
import { getPresentationPaths } from "./presentation/content.ts";
import {
...
} from "./presentation/diagnostics.ts";
import { buildErrorPresentation } from "./presentation/errors.ts";
import { compactLargePresentationOutput } from "./presentation/large-output.ts";
import { buildPageChangeSummary } from "./presentation/navigation.ts";
import { formatPresentationContentText, formatPresentationSummary } from "./presentation/registry.ts";
import { resolvePresentationCommandInfo } from "./presentation/semantic-action.ts";
...
export async function buildToolPresentation(options: {
	...
	networkRoutes?: import("./contracts.ts").NetworkRouteRecord[];
