...
export function getArrayField<Value>(data: Record<string, Value>, key: string): AgentBrowserResultValue[] | undefined {
...
export function getStringField<Value>(data: Record<string, Value>, key: string): string | undefined {
	const value = data[key];
