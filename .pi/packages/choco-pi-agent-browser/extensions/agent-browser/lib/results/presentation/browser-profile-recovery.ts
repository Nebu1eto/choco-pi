...
import { getStartupScopedFlags, type CommandInfo } from "../../runtime.ts";
import type { AgentBrowserNextAction } from "../contracts.ts";
import { buildNextToolAction } from "../next-actions.ts";
