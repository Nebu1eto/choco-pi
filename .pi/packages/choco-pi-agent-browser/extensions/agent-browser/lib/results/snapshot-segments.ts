import type { SnapshotLineRefInfo, SnapshotRefEntry } from "./snapshot-refs.ts";
import { normalizeWhitespace, truncateText } from "./text.ts";
...
interface SnapshotRolePriorities {
	[role: string]: number;
}

const SNAPSHOT_ROLE_PRIORITY: SnapshotRolePriorities = {
	article: 0,
	main: 1,
	dialog: 2,
	menu: 3,
