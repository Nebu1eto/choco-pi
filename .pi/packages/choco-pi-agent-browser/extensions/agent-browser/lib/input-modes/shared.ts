...
export type SelectValuesResult = { error: string } | { values: string[] };
...
export function isOneOf<Value, const Values extends readonly string[]>(
  value: Value,
  values: Values,
): value is Value & Values[number] {
...
export function validateLookupMaxWorkspaceFiles<Value>(
  value: Value,
  fieldName: string,
