...
import type { ElectronCleanupResult, ElectronLaunchStatus } from "../../electron/cleanup.ts";
import type { ElectronCdpTarget, ElectronLaunchRecord, ElectronLaunchSuccess } from "../../electron/launch.ts";
import type { AgentBrowserNetworkSourceLookupAnalysis, AgentBrowserQaPresetAnalysis, AgentBrowserSourceLookupAnalysis, CompiledAgentBrowserElectron, CompiledAgentBrowserJob, CompiledAgentBrowserNetworkSourceLookup, CompiledAgentBrowserQaPreset, CompiledAgentBrowserSemanticAction, CompiledAgentBrowserSourceLookup } from "../../input-modes/types.ts";
import type { runAgentBrowserProcess } from "../../process.ts";
import type { AgentBrowserEnvelope, AgentBrowserNextAction, NetworkRouteRecord, SessionArtifactManifest } from "../../results/contracts.ts";
import type { buildAgentBrowserResultCategoryDetails } from "../../results/categories.ts";
import type { buildToolPresentation } from "../../results/presentation.ts";
import type { RichInputRecoveryDiagnostic, VisibleRefFallbackDiagnostic } from "../../results/selector-recovery.ts";
import type { SessionPageState, SessionRefSnapshot, SessionRefSnapshotInvalidation, SessionTabTarget } from "../../session-page-state.ts";
import type { buildExecutionPlan, CompatibilityWorkaround, OpenResultTabCorrection } from "../../runtime.ts";
import type { ManagedSessionRestoreState, OwnedManagedSessionContext } from "../../managed-session-restore.ts";
import type { ManagedSessionPolicyLock } from "../../managed-session-policy-lock.ts";
import type { AllowedDomainsPolicy } from "../../navigation-policy.ts";
import type { PromptPolicy } from "../../prompt-policy.ts";
import type { AgentBrowserExecuteParams, ResolvedAgentBrowserValidInput } from "../input-plan.ts";
import type { BatchCommandStep } from "../batch-stdin.ts";
...
export type { BatchCommandStep } from "../batch-stdin.ts";
...
export interface PreparedBrowserRun {
	...
	redactedRecoveryHint?: ReturnType<typeof import("../../runtime.ts").buildExecutionPlan>["recoveryHint"];
