...
function relationLabel(relation: string | undefined): string {
	switch (relation) {
		case "api-catalog": return "API catalog";
		case "describedby": return "Description";
		case "service-desc": return "Service description";
		case "service-doc": return "Service documentation";
		case "service-meta": return "Service metadata";
		default: return "Declared link";
	}
}
...
function formatDeclaredLink(link: DeclaredWebLink): string {
	...
	const label = relationLabel(link.relations[0]);
