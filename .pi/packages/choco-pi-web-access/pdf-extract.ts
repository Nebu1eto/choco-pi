...
interface PromiseConstructorWithTry extends PromiseConstructor { try?: (...args: never[]) => Promise<never> }
...
export async function extractPDFToMarkdown(
	...
	const metaTitleValue = metadataInfo ? Object.getOwnPropertyDescriptor(metadataInfo, "Title")?.value : undefined;
	const metaAuthorValue = metadataInfo ? Object.getOwnPropertyDescriptor(metadataInfo, "Author")?.value : undefined;
