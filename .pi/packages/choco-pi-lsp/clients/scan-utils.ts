 ...
 */
export function shouldIgnoreFile(filePath: string, isTsProject: boolean): boolean {
 ...
 */
export function getSourceFilesAsync(dir: string, _isTsProject?: boolean): Promise<string[]> {
