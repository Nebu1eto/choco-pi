...
const MAX_LOG_BYTES = Math.max(
  128 * 1024,
  Number.parseInt(process.env.CHOCO_PI_LSP_AST_GREP_LOG_MAX_BYTES ?? "1048576", 10) || 1048576,
);
 ...
 */
export function classifyAstGrepError(errorMessage: string | undefined): AstGrepErrorKind {
