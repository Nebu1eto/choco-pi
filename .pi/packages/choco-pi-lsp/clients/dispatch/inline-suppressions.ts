/**
 * Inline `choco-pi-lsp-ignore` suppression — shared between the per-edit dispatch
 ...
 *
 * Syntax: `// choco-pi-lsp-ignore: rule-id` (JS/TS) or `# choco-pi-lsp-ignore: rule-id`
...
/**
 * Normalize a rule id to the form a user writes in a `choco-pi-lsp-ignore` comment.
...
/**
 * Drop diagnostics suppressed by an inline `choco-pi-lsp-ignore: <rule[,rule2]>`
