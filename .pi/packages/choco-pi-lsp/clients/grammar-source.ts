...
export function _setGrammarManifestForTests(manifest: GrammarManifest | null | undefined): void {
...
export async function downloadGrammar(destDir: string, filename: string): Promise<boolean> {
