...
const REGISTERED_PHASES: ReadonlySet<string> = new Set(BOUNDED_TELEMETRY_PHASES);
 ...
 */
function admitAgainstTurnCap(phase: string, cap: BoundedTelemetryOptions["capPerTurn"]): boolean {
