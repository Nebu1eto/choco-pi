...
export type ReviewGraphStructuralIr = JsTsReviewGraphIr | TreeSitterReviewGraphIr;
...
export function publishReviewGraphFileIr(cwd: string, entry: ReviewGraphFileIr): void {
