...
export class TreeSitterSymbolExtractor {
  ...
  private extractDocCommentInfo(declNode: any): { text: string; startLine: number } | undefined {
    ...
    const sameStartRow = (a: any, b: any) => a?.startPosition?.row === b?.startPosition?.row;
