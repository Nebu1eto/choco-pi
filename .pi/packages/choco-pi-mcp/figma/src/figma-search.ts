...
export function findNodesByName(node: FigmaValue, options: FigmaFindNodesOptions): FigmaNodeSearchResult {
	return findNodes(node, normalizeOptions(options), "name");
}

export function findNodesByText(node: FigmaValue, options: FigmaFindNodesOptions): FigmaNodeSearchResult {
	return findNodes(node, normalizeOptions(options), "text");
}

function findNodes(root: FigmaValue, options: NormalizedSearchOptions, matchType: "name" | "text"): FigmaNodeSearchResult {
	...
	function visit(node: FigmaValue, level: number, path: string, parent?: FigmaNodeSearchMatch["parent"]): void {
