...
export function buildFrameworkHints(summary: FigmaNodeSummary, options: FigmaImplementationOptions): FigmaRecord | undefined {
...
function walk(node: FigmaValue, visit: (record: FigmaRecord, path: string) => void, path = ""): void {
	const record = asRecord(node);
