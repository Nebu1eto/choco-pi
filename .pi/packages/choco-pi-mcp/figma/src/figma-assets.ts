...
export function collectAssetCandidates(node: FigmaValue, options: { assetTypes?: FigmaAssetType[]; includeHidden?: boolean; maxAssets?: number } = {}): FigmaAssetCollectionResult {
...
function walk(node: FigmaValue, includeHidden: boolean, visit: (record: FigmaRecord, path: string, level: number) => void, path = "", level = 0): void {
