...
export function migrateCodexConversionConfigIfNeeded(value: unknown): {
  migrated: boolean;
  config: unknown;
} {
      ...
      return {
        ...
        config: {
          ...
          openai: {
            ...openai,
            proxyResponsesLite:
              typeof openai["proxyResponsesLite"] === "boolean"
  ...
  const config: CodexConversionConfig = {
    ...
    tools: {
      ...
      applyPatchOnly:
        typeof value["applyPatchOnly"] === "boolean"
    ...
    ui: {
      ...
      backgroundShellWidget:
        typeof value["backgroundShellWidget"] === "boolean"
    ...
    compaction: {
      responsesCompaction:
        typeof value["responsesCompaction"] === "boolean"
    ...
    openai: {
      ...
      forceCachedWebSockets:
        typeof value["forceCachedWebSockets"] === "boolean"
