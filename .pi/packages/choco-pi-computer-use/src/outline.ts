...
export function parseLookResponse(raw: JsonValue): LookResponse {
	...
	const look: LookResponse = {
		...
		timings: isJsonObject(record.timings) ? Object.fromEntries(Object.entries(record.timings).map(([key, value]) => [key, toNumber(value)])) : {},
...
export function searchOutlineRanked(outline: Outline, text?: string, role?: string, capability?: string, limit = 12): RankedOutlineMatches {
