...
import { isString, type JsonValue } from "../../json.ts";
...
export class MacosHelperClient {
	...
	async daemonCommand<T, TArgs extends object = object>(cmd: string, args: TArgs, timeoutMs: number, signal?: AbortSignal): Promise<T> {
